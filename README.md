...
HarborSonar provides non-intrusive security audits using scripted pipelines and AI-enhanced interpretation (Lumo). All findings are manually verified by the lead analyst. Zero production impact, fully repeatable.
...
Served as a static site via GitHub Pages with a custom domain.

```
harborsonar.com → GitHub Pages
```

## Author

A. Michael Tatum, Cloud Linux Engineer — Georgetown, Texas
